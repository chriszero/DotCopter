...
namespace MFTwoWayOperationDeviceSample
{
    public class Program
    {
        public static void Main()
        {
            ...
            Device.HostedServices.Add(new TwoWayOperationService());

            // Metadata
            // Model
            Device.ThisModel.Manufacturer = "Apress, Inc.";
            Device.ThisModel.ManufacturerUrl = "http://www.apress.com";
            Device.ThisModel.ModelName = "TwoWayOperationModel";
            ...
            // Device
            Device.ThisDevice.FriendlyName = "Two-way operation service device";
